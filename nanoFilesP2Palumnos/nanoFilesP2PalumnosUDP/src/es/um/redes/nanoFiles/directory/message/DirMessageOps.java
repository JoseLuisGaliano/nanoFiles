...
public class DirMessageOps {
	...
	public static final byte OPCODE_SERVE_FILES_STOP = 12;
	public static final byte OPCODE_SERVE_FILES_STOP_OK = 13;
	public static final byte OPCODE_GETUSERS = 14;
	public static final byte OPCODE_USERLIST = 15;
	public static final byte OPCODE_GETFILES = 17;
	public static final byte OPCODE_FILELIST = 18;
	public static final byte OPCODE_LOGOFF = 19;
	public static final byte OPCODE_QUIT = 20;
	...
	private static final Byte[] _valid_opcodes = { 
			...
			OPCODE_SERVE_FILES_STOP,
			OPCODE_SERVE_FILES_STOP_OK,
			OPCODE_GETUSERS,
			OPCODE_USERLIST, 
			OPCODE_GETFILES, 
			OPCODE_FILELIST, 
